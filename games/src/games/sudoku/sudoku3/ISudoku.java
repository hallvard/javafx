...
public interface ISudoku extends IUndoable, IPersistable, ObservableGrid {
	...
	/**
	 * Calculates a list of integers that can be legally placed at the cell in location x, y.
	 * @param x The x-coordinate of the cell
	 * @param y The y-coordinate of the cell
	 * @return The list of digits that can be placed in the cell at location x, y.
	 */
