...
public abstract class ImageGridGame<T> extends FxmlGame {
...
//		imageGrid.requestFocus();
	...
	protected void tick() {
		super.tick();
		if (imageGrid.getOnTick() != null) {
			imageGrid.getOnTick().handle(new ActionEvent(this, imageGrid));
		}
	}
